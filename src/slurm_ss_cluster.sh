...
#SBATCH --mem=20G
#SBATCH -J Cluster_SS
#SBATCH -o m_test/out/g2v_cluster_ss-%A_%a.out
#SBATCH --error=m_test/error/g2v_cluster_ss-%A_%a.err   # Standard  error log
...
python main.py --input ../graph/  --output ../emb/ --p 1 --q 1 --walk-length $l --num-walks $n --dataset $SLURM_ARRAY_TASK_ID --l_type cluster --ss
date
