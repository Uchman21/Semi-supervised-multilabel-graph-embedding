...
#SBATCH --mem=20G
#SBATCH -J Cluster_SU
#SBATCH -o m_test/out/g2v_cluster_su-%A_%a.out
#SBATCH --error=m_test/error/g2v_cluster_su-%A_%a.err   # Standard  error log
...
python main.py --input ../graph/  --output ../emb/ --p 1 --q 1  --num-walks $n --walk-length $l --dataset $SLURM_ARRAY_TASK_ID --l_type cluster --su
date
